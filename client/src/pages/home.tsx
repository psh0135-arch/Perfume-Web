  ...
  const reviews = [
    {
      ...
      rating: 5,
      review:
        "정말 오래 지속되고 향이 너무 고급스러워요. 주변에서 향수 뭘 쓰냐고 자꾸 물어봐요 ㅎㅎ",
      date: "2024.01.15",
    },
    {
      name: "박민정",
      ...
      rating: 5,
      review:
        "첫 스프레이부터 완전 반했어요! 플로럴인데 너무 달지 않고 세련된 느낌이에요.",
      date: "2024.01.12",
    },
    {
      name: "이수진",
      ...
      rating: 5,
      review:
        "이 가격에 이런 품질이라니! 백화점 브랜드 못지않아요. 재주문 예정입니다.",
      date: "2024.01.10",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "평일 오후 2시 이전 주문 시 당일 발송되며, 1-2일 내 수령 가능합니다. 제주도 및 도서산간 지역은 추가 1일이 소요될 수 있습니다.",
      icon: "fas fa-shipping-fast",
    },
    {
      question: "정품 보장이 되나요?",
      answer:
        "네, 100% 정품만을 취급합니다. 모든 제품에는 정품 인증서가 동봉되며, 만약 가품으로 판명될 경우 전액 환불 및 배상해드립니다.",
      icon: "fas fa-certificate",
    },
    {
      question: "교환/반품이 가능한가요?",
      answer:
        "미개봉 제품에 한해 수령 후 7일 내 교환/반품 가능합니다. 단순 변심의 경우 왕복 배송비는 고객 부담입니다.",
      icon: "fas fa-undo",
    },
    {
      question: "향이 얼마나 오래 지속되나요?",
      answer:
        "EDP(Eau de Parfum) 타입으로 8-10시간 지속됩니다. 개인차 및 환경에 따라 차이가 있을 수 있습니다.",
      icon: "fas fa-clock",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans relative">
      ...
      >
        ...
        <div className="container mx-auto px-4 py-16 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            <h1
              className="text-5xl md:text-7xl font-serif font-bold mb-6 leading-tight hero-text"
              data-testid="hero-title"
            >
              <span className="text-contrast">나만의 시그니처</span>
              <br />
              <span className="text-secondary font-black">향기를 찾아서</span>
            </h1>

            <p
              className="text-xl md:text-2xl text-muted-foreground mb-8 font-medium text-shadow"
              data-testid="hero-subtitle"
            >
              기억 속 그 순간을 되살리는 특별한 향기
              <br />
              우디 & 플로럴의 완벽한 조화
            </p>
            ...
            >
              <span className="text-3xl md:text-4xl font-black text-accent text-shadow-strong">
                67% 할인
              </span>
              <span className="text-lg text-muted-foreground line-through font-semibold">
                ₩198,000
              </span>
              <span className="text-2xl md:text-3xl font-black text-secondary text-shadow-strong">
                ₩65,000
              </span>
            </div>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, hsl(350, 15%, 92%) 0%, hsl(340, 20%, 94%) 50%, hsl(330, 25%, 96%) 100%)",
          boxShadow:
            "inset 0 0 60px rgba(255, 215, 0, 0.1), inset 0 0 40px rgba(255, 105, 180, 0.05)",
        }}
      >
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2
              className="text-4xl md:text-5xl font-serif font-bold mb-8 text-contrast text-shadow"
              data-testid="empathy-title"
            >
              향기는 기억을 부른다
            </h2>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, hsl(350, 30%, 96%) 0%, hsl(340, 25%, 97%) 50%, hsl(330, 20%, 98%) 100%)",
          boxShadow:
            "inset 0 0 80px rgba(255, 192, 203, 0.15), inset 0 0 40px rgba(255, 215, 0, 0.08)",
        }}
      >
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2
                className="text-4xl md:text-5xl font-serif font-bold mb-6 text-contrast text-shadow"
                data-testid="product-title"
              >
                Premium{" "}
                <span className="text-secondary font-black">Signature</span>{" "}
                Collection
              </h2>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                <GlassCard className="p-8">
                  ...
                  <h3
                    className="text-3xl font-serif font-bold mb-4 text-secondary"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2
                className="text-4xl md:text-5xl font-serif font-bold mb-6 text-contrast text-shadow"
                data-testid="fragrance-story-title"
              >
                향기의 여정
              </h2>
              <p className="text-xl text-muted-foreground">
                세 개의 노트가 만들어내는 완벽한 하모니
              </p>
            </div>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, hsl(350, 30%, 96%) 0%, hsl(340, 25%, 97%) 50%, hsl(330, 20%, 98%) 100%)",
          boxShadow:
            "inset 0 0 100px rgba(255, 105, 180, 0.12), inset 0 0 50px rgba(255, 215, 0, 0.06)",
        }}
      >
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
      ...
      <section className="py-20 bg-card" data-testid="event-section">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <GlassCard className="p-8">
              <h2
                className="text-3xl md:text-4xl font-serif font-bold mb-6 text-accent"
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, hsl(350, 15%, 92%) 0%, hsl(340, 20%, 94%) 50%, hsl(330, 25%, 96%) 100%)",
          boxShadow:
            "inset 0 0 120px rgba(255, 215, 0, 0.2), inset 0 0 60px rgba(255, 105, 180, 0.15)",
        }}
      >
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <GlassCard className="p-8 mb-8 max-w-md mx-auto">
              <div className="text-center" data-testid="stock-indicator">
                ...
                <div className="bg-muted rounded-full h-3 mb-2">
                  <div
                    className="bg-gradient-to-r from-destructive to-accent h-3 rounded-full"
                    style={{ width: "23%" }}
                  ></div>
                </div>
            ...
            <div className="space-y-4">
              ...
              >
                <span>
                  <i className="fas fa-shield-alt mr-1"></i> 100% 정품보장
                </span>
                <span>
                  <i className="fas fa-truck mr-1"></i> 무료배송
                </span>
                <span>
                  <i className="fas fa-undo mr-1"></i> 7일 무료교환
                </span>
              </div>
            </div>
          </div>
